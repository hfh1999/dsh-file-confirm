/**
 * @local/dsh-file-confirm — Browser 半身
 *
...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const cssId = '@local/dsh-file-confirm/FileChangeStrip.css';
    if (typeof document !== 'undefined' && document.querySelector('style[data-plugin-css="' + cssId + '"]') === null) {
      const tag = document.createElement('style');
      tag.dataset.plugin = '@local/dsh-file-confirm';
